...
public class Assignment002 {
	...
	public void assignment002Post() {
		...
		File file = new File("C:\\Users\\shaik\\eclipse-workspace\\Phase3-Endproject\\src\\main\\resource\\data.json");
	...
	public void assignment002Put() {
		File file = new File("C:\\Users\\shaik\\eclipse-workspace\\Phase3-Endproject\\src\\main\\resource\\dataput.json");
		int id = RestAssured.given().baseUri("https://petstore.swagger.io/v2/pet/").contentType(ContentType.JSON)
